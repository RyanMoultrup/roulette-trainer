    ...
    <div class="flex flex-col justify-between h-full">
      <div class="flex flex-row">
        <div class="border-r border-r-green-700 grow pr-4">
          ...
          <div class="relative">
            <div class="grid grid-cols-[1.3fr,0.9fr,0.9fr,1fr,0.9fr] top-0 left-0 w-full px-2 pt-2 border-b border-b-green-400">
              <span>Placement</span>
              <span>Odds</span>
              <span>Bet</span>
              <span>Outcome</span>
            ...
            <div class="relative px-2 pb-2 pt-1 max-h-40 overflow-y-auto border-t border-t-green-600">
              <div v-for="bet in bets" :key="bet.type" class="border-b border-b-green-600">
        ...
        <div class="border-l border-l-green-900 px-4 pb-4">
          ...
          <div class="w-80 p-2 max-h-40 overflow-y-auto">
            <div v-for="spot in getHighestPayout" :key="spot" class="flex flex-col border-b border-b-green-600 py-0.5">
