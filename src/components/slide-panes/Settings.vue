<template>
  <slide-panel :show="show">
    <div class="slider-panel h-full bg-gradient-to-tr from-0% from-accent-150 via-35% via-green-800 to-green-800">
      <div>
...
export default {
  components: { SlideInFromRightTransition, FadeInTransition, SlidePanel },
  setup () {
